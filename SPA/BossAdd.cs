    ...
    public partial class BossAdd : Form
    {
      ...
      List<string> list = new List<string>();
...

        {
          ...
          t.SetToolTip(this.button11, "Добавить Spa программу");
          t.SetToolTip(this.button12, "Удалить Spa программу");
          t.SetToolTip(this.button14, "Добавить описание к Spa программе");
           ...
           // listBox1.DataSource = myDataSet.Tables["Процедуры"].DefaultView;
        ...
        {
          string cmd = "INSERT INTO spa_процедуры (Название)  VALUES ('" + textBox8.Text + "')";
          try
          {
            myDataAdapter.InsertCommand = new OleDbCommand(cmd, myOleDbConnection);
        ...
        private void button16_Click(object sender, EventArgs e)
        {
          ...
          //{
          //  list.Add(checkedListBox1.Text);
          //  MessageBox.Show("Item with title: \"" + checkedListBox1.Text);//itemChecked.ToString());
          //  //checkedListBox1.CheckedItems[q].ToString();
